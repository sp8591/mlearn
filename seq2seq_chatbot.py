...
min_freq = 10
wordToken = word_token.WordTocken()
...
def get_train_set():
    global num_decoder_symbols, num_encoder_symbols
    train_set = []
        ...
        with open('./samples/answer', 'r') as answer_file:
            while True:
                ...
                if question and answer:
                    question_id_list = get_id_list_from(question.strip())
                    answer_id_list = get_id_list_from(answer.strip())
